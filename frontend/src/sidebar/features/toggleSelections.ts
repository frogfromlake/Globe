...
export function toggleCountryInteractivity(button: HTMLButtonElement): void {
  appState.countryInteractivity =
    !appState.countryInteractivity;
  button.textContent = appState.countryInteractivity
...
export function toggleOceanInteractivity(button: HTMLButtonElement): void {
  appState.oceanInteractivity = !appState.oceanInteractivity;
  button.textContent = appState.oceanInteractivity
